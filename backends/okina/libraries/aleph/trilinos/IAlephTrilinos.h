 ...
 *****************************************************************************/
  int AlephMatrixSolve(AlephVector* x,
    ...
    case TypesSolver::SPAIstat : throw ArgumentException(func_name,"preconditionnement AztecOO::SPAIstat indisponible");
    case TypesSolver::AINV     : throw ArgumentException(func_name,"preconditionnement AztecOO::AINV indisponible");
    case TypesSolver::SPAIdyn  : throw ArgumentException(func_name,"preconditionnement AztecOO::SPAIdyn indisponible");
