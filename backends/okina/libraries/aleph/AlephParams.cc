...
// set
void AlephParams::setEpsilon(const Real epsilon){m_param_epsilon = epsilon;}
void AlephParams::setMaxIter(const Integer max_iteration){m_param_max_iteration = max_iteration;}
...
void AlephParams::setAlpha(const Real alpha){m_param_alpha=alpha;}
void AlephParams::setGamma(const Integer gamma){m_param_gamma=gamma;}
...
void AlephParams::setMinRHSNorm(const Real min_rhs_norm){m_param_min_rhs_norm=min_rhs_norm;}
...
void AlephParams::setDDMCParameterAmgDiagonalThreshold(const Real threshold){m_param_threshold=threshold;}
...
void AlephParams::setOutputLevel(const Integer output_level){m_param_output_level=output_level;}
void AlephParams::setAmgCycle(const Integer amg_cycle){m_param_amg_cycle=amg_cycle;}
void AlephParams::setAmgSolverIter(const Integer amg_solver_iterations){m_param_amg_solver_iterations=amg_solver_iterations;}
void AlephParams::setAmgSmootherIter(const Integer amg_smoother_iterations){m_param_amg_smoother_iterations=amg_smoother_iterations;}
...
// get
Real AlephParams::epsilon()const{return m_param_epsilon;}
int AlephParams::maxIter()const{return m_param_max_iteration;}
Real AlephParams::alpha()const{return m_param_alpha;}
...
Real AlephParams::minRHSNorm(){return m_param_min_rhs_norm;}
...
Real AlephParams::DDMCParameterAmgDiagonalThreshold()const{return m_param_threshold;}
