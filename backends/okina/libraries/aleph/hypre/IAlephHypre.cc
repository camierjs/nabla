...
/******************************************************************************
 AlephVectorHypre
 *****************************************************************************/
  AlephVectorHypre::AlephVectorHypre(ITraceMng *tm,AlephKernel *kernel, Integer index):
 ...
 * matrix as well.
*****************************************************************************/
void AlephVectorHypre::AlephVectorCreate(void){
...
/******************************************************************************
 *****************************************************************************/
void AlephVectorHypre::AlephVectorSet(const double *bfr_val, const int *bfr_idx, Integer size){
...
/******************************************************************************
 *****************************************************************************/
int AlephVectorHypre::AlephVectorAssemble(void){
...
/******************************************************************************
 *****************************************************************************/
void AlephVectorHypre::AlephVectorGet(double *bfr_val, const int *bfr_idx, Integer size){
  ...
  * norm_max
  *****************************************************************************/
Real AlephVectorHypre::norm_max(){
    Real normInf=0.0;
    Array<HYPRE_Int> bfr_idx(jSize);
    Array<double> bfr_val(jSize);
    ...
    hypreCheck("HYPRE_IJVectorGetValues", HYPRE_IJVectorGetValues(m_hypre_ijvector,
                                                                  jSize,
                                                                  bfr_idx.unguardedBasePointer(),
                                                                  bfr_val.unguardedBasePointer()));
    for(HYPRE_Int i=0;i<jSize;++i){
      const Real abs_val = fabs(bfr_val[i]);
...
/******************************************************************************
 *****************************************************************************/
void AlephVectorHypre::writeToFile(const String filename){
...
/******************************************************************************
 AlephMatrixHypre
 *****************************************************************************/
AlephMatrixHypre::AlephMatrixHypre(ITraceMng *tm,
                   AlephKernel *kernel,
                   Integer index):
...
AlephMatrixHypre::~AlephMatrixHypre(){
 ...
 *****************************************************************************/
void AlephMatrixHypre::AlephMatrixCreate(void){
    ...
    HYPRE_IJMatrixSetRowSizes(m_hypre_ijmatrix,
                              m_kernel->topology()->gathered_nb_row_elements().begin());
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::AlephMatrixSetFilled(bool){}

/******************************************************************************
 *****************************************************************************/
int AlephMatrixHypre::AlephMatrixAssemble(void){
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::AlephMatrixFill(int size, int *rows, int *cols, double *values){
 ...
 * isAlreadySolved
 *****************************************************************************/
bool AlephMatrixHypre::isAlreadySolved(AlephVectorHypre *x,
                       AlephVectorHypre *b,
...
/******************************************************************************
 *****************************************************************************/
int AlephMatrixHypre::AlephMatrixSolve(AlephVector* x,
                       AlephVector* b,
                       AlephVector* t,
    ...
    default : throw ArgumentException("AlephMatrixHypre::AlephMatrixSolve","solveur inconnu");
    }
    ...
    case TypesSolver::AINV     : throw ArgumentException("AlephMatrixHypre::AlephMatrixSolve",
                                                         "preconditionnement AINV indisponible");
    case TypesSolver::SPAIdyn  : throw ArgumentException("AlephMatrixHypre::AlephMatrixSolve",
                                                         "preconditionnement SPAIdyn indisponible");
    case TypesSolver::ILUp     : throw ArgumentException("AlephMatrixHypre::AlephMatrixSolve",
                                                         "preconditionnement ILUp indisponible");
    case TypesSolver::IC       : throw ArgumentException("AlephMatrixHypre::AlephMatrixSolve",
                                                         "preconditionnement IC indisponible");
    case TypesSolver::POLY     : throw ArgumentException("AlephMatrixHypre::AlephMatrixSolve",
                                                         "preconditionnement POLY indisponible");
    default : throw ArgumentException("AlephMatrixHypre::AlephMatrixSolve",
...
*/
    ...
    default : throw ArgumentException("AlephMatrixHypre::AlephMatrixSolve","preconditionnement inconnu");
    }
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::writeToFile(const String filename){
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::initSolverPCG(const AlephParams* solver_param,HYPRE_Solver& solver){
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::initSolverBiCGStab(const AlephParams* solver_param,HYPRE_Solver& solver){
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::initSolverGMRES(const AlephParams* solver_param,HYPRE_Solver& solver){
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::setDiagonalPreconditioner( const TypesSolver::eSolverMethod solver_method ,
   ...
   switch(solver_method){
    ...
    case TypesSolver::GMRES :
      ...
      break;
    default:
      throw ArgumentException("SolverMatrixHypre::setDiagonalPreconditioner","solveur inconnu pour preconditionnement 'Diagonal'");
    }
  }
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::setILUPreconditioner(const TypesSolver::eSolverMethod solver_method ,
                            const HYPRE_Solver& solver,
                            HYPRE_Solver& precond){
    switch(solver_method){
    case TypesSolver::PCG :
      throw ArgumentException("SolverMatrixHypre::setILUPreconditioner",
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::setSpaiStatPreconditioner(const TypesSolver::eSolverMethod solver_method ,
                                 const HYPRE_Solver& solver,
    ...
    case TypesSolver::PCG:
      ...
      break;
    case TypesSolver::BiCGStab:
      throw ArgumentException("AlephMatrixHypre::setSpaiStatPreconditioner",
...
/******************************************************************************
 *****************************************************************************/
void AlephMatrixHypre::setAMGPreconditioner(const TypesSolver::eSolverMethod solver_method ,
                            const HYPRE_Solver& solver        ,
                            const AlephParams* solver_param  ,
                            HYPRE_Solver& precond){
...
/******************************************************************************
 *****************************************************************************/
bool AlephMatrixHypre::solvePCG
  ( const AlephParams* solver_param ,
    HYPRE_Solver&       solver       ,
...
/******************************************************************************
 *****************************************************************************/
bool AlephMatrixHypre::solveBiCGStab
  ( HYPRE_Solver&       solver       ,
    HYPRE_ParCSRMatrix& M            ,
    HYPRE_ParVector&    B            ,
    HYPRE_ParVector&    X            ,
...
/******************************************************************************
 *****************************************************************************/
bool AlephMatrixHypre::solveGMRES
  ( HYPRE_Solver&       solver       ,
    HYPRE_ParCSRMatrix& M            ,
    HYPRE_ParVector&    B            ,
    HYPRE_ParVector&    X            ,
...
HypreAlephFactoryImpl::HypreAlephFactoryImpl(ITraceMng *tm):
  TraceAccessor(tm),
  m_IAlephVectors(0),
  m_IAlephMatrixs(0){}
