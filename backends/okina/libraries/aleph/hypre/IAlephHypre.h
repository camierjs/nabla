/*---------------------------------------------------------------------------*/
/* AlephHypre.h                                                (C) 2010-2013 */
/*                                                                           */
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
#ifndef ARCANE_ALEPH_INTERFACE_HYPRE_H
#define ARCANE_ALEPH_INTERFACE_HYPRE_H
 ...
 *****************************************************************************/
  void AlephMatrixCreate(void){
    ...
    HYPRE_IJMatrixSetRowSizes(m_hypre_ijmatrix, m_kernel->topology()->gathered_nb_row_elements().begin());
 ...
 *****************************************************************************/
  int AlephMatrixSolve(AlephVector* x,
    ...
    default : throw ArgumentException(func_name,"solveur inconnu");
    }
    ...
    case TypesSolver::AINV     : throw ArgumentException(func_name,"preconditionnement AINV indisponible");
    case TypesSolver::SPAIdyn  : throw ArgumentException(func_name,"preconditionnement SPAIdyn indisponible");
    case TypesSolver::ILUp     : throw ArgumentException(func_name,"preconditionnement ILUp indisponible");
    case TypesSolver::IC       : throw ArgumentException(func_name,"preconditionnement IC indisponible");
    case TypesSolver::POLY     : throw ArgumentException(func_name,"preconditionnement POLY indisponible");
    default : throw ArgumentException(func_name,"preconditionnement inconnu");
    }
