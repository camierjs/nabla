...
# CTESTS TEMPLATE #
###################
tests = p1apwb1D_two_state_semi_implicite #upwind deflex upwindAP lulesh darcy ndspmhd mhydro glace2D #p1apwb1D_gosse heat aleph1D kripke darcy deflex llsh lulesh shydro sethi anyItem gad comd pDDFV
