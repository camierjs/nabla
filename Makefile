...
# CTESTS TEMPLATE #
###################
tests = mhydro ddfv xgnplt pdfLgvn fmly deflex hlt aleph1D aleph2D glc glace2D xst upwindAP lulesh #upwind deflex upwindAP lulesh darcy ndspmhd mhydro glace2D
