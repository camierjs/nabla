...
# CTESTS TEMPLATE #
###################
tests = ndspmhd comd pDDFV schrodinger glace aecjs nvknl darcy amber heat p1apwb1D_version_2 p12d upwind p1apwb1D_implicite propagateur drc mhydro ddfv xgnplt pdfLgvn fmly deflex hlt aleph1D aleph2D glc glace2D xst upwindAP lulesh llsh
